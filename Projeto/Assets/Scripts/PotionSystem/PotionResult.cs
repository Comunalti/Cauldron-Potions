...
namespace PotionSystem
{
    ...
    public class PotionResult : ScriptableObject
    {
        ...
        {
            GameObject clone = Instantiate(Prefab,position,Quaternion.identity); //isGood?Instantiate(goodPrefab,position,Quaternion.identity):Instantiate(badPrefab,position,Quaternion.identity);
